...
try {
    ...
    if ($count == 0) {
        ...
        $pdo->exec("INSERT INTO `events` (`name`, `description`, `date`, `time`, `venue`, `price`, `coordinators`) VALUES
        ...
        echo "<p>Database setup completed successfully. Sample events have been added.</p>";
    } else {
        echo "<p>Database is already set up and contains events.</p>";
    }
